...
public partial class JardineriaContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=localhost;user=root;password=utilizar;database=jardineria", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.35-mysql"));
